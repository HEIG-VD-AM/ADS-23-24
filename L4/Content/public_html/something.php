...
<head>
        ...
        <script src="lab04_template/js/ScriptResource1.axd" type="text/javascript"></script>
        <script src="lab04_template/js/ScriptResource2.axd" type="text/javascript"></script>
        <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,700,400italic" rel="stylesheet" type="text/css">
        <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.6.3/css/font-awesome.min.css" rel="stylesheet">
        <link href="lab04_template/css/slick.css" rel="stylesheet">
        <link href="lab04_template/css/styles.min.css" rel="stylesheet" type="text/css" />
        <link href="lab04_template/css/custom.css" rel="stylesheet">
        ...
        <body id="top">
                ...
                <div>
                        ...
                        <a href="/">
                                <img class="img-responsive logo" style="width: 96px; left: 15px;" src="lab04_template/img/logo-heig-vd.svg" alt="">
                        </a>
                        <div class="container">
                                <div class="row">
                ...
                <a href="#">
                        <img class="visible-xs visible-sm img-responsive logo" style="width: 96px; left: 15px;" src="lab04_template/img/logo-heig-vd.svg" alt="">
                </a>

                <style type="text/css">
                  .superpicture-loading { background-image: url(lab04_template/img/banner.jpg); }
                  @media (min-width: 768px) { .superpicture-loading { background-image: url(lab04_template/img/banner.jpg); } }
                  @media (min-width: 992px) { .superpicture-loading { background-image: url(lab04_template/img/banner.jpg); } }
                  @media (min-width: 1200px) { .superpicture-loading { background-image: url(lab04_template/img/banner.jpg); } }
                </style>
...
?>
                  ...
                  <div class="superpicture__watermark">
                        <img class="img-responsive" src="lab04_template/img/logo-hes-so.svg" alt="">
                  </div>
                </header>
<article class="container article">
    <div class="row">
        <div class="col-md-10 col-md-pull-3 col-md-offset-4 article__content">
            ...
            <div class="row">
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/cheseaux.png"><img class="vignette" src="./raw_files/lab04_thumbnails/cheseaux_thumb.png" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/img-430.png"><img class="vignette" src="./raw_files/lab04_thumbnails/img-430_thumb.png" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/st-roch.png"><img class="vignette" src="./raw_files/lab04_thumbnails/st-roch_thumb.png" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/yparc.png"><img class="vignette" src="./raw_files/lab04_thumbnails/yparc_thumb.png" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/cours.jpg"><img class="vignette" src="./raw_files/lab04_thumbnails/cours_thumb.jpg" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/dcim439.jpg"><img class="vignette" src="./raw_files/lab04_thumbnails/dcim439_thumb.jpg" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/mur.jpg"><img class="vignette" src="./raw_files/lab04_thumbnails/mur_thumb.jpg" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/showroom_fabrik.jpg"><img class="vignette" src="./raw_files/lab04_thumbnails/showroom_fabrik_thumb.jpg" /></a></div>
            </div>
        </div>
    </div>
    <div class="row" style="margin-top: 40px;">
        <div class="col-md-10 col-md-pull-3 col-md-offset-4 article__content">
            ...
            <div class="row">
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/rapport-activite-2018.pdf"><img class="vignette" src="./raw_files/lab04_thumbnails/rapport-activite-2018_thumb.jpg" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/rapport-activite-2019.pdf"><img class="vignette" src="./raw_files/lab04_thumbnails/rapport-activite-2019_thumb.jpg" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/rapport-activite-2020.pdf"><img class="vignette" src="./raw_files/lab04_thumbnails/rapport-activite-2020_thumb.jpg" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/rapport-annuel-2018.pdf"><img class="vignette" src="./raw_files/lab04_thumbnails/rapport-annuel-2018_thumb.jpg" /></a></div>
<div class="col-md-6 col-xs-12"><a href="./raw_files/lab04_raw_files/rapport-annuel-2019.pdf"><img class="vignette" src="./raw_files/lab04_thumbnails/rapport-annuel-2019_thumb.jpg" /></a></div>
            </div>
        </div>
    </div>
</article>
                                        ...
                                        <div class="col-md-10 col-md-offset-1">
                                         <div class="row">
                                                 ...
                                                 <div class="col-sm-4 hidden-xs">
                                                         <div>
                                                                <a href="http://www.vd.ch"> <img class="img-responsive pull-right m-l-3" src="lab04_template/img/logo-vd.png" alt="Canton de Vaud"> </a>
                                                                <a href="http://www.hes-so.ch"> <img class="img-responsive pull-right" src="lab04_template/img/logo-hes-so.png" alt="HES-SO"> </a>
                                                         </div>
                                                 </div>
                                                 </div>
                                         </div>
